================================================================================
HLP09 REPORT SERVER – HOW2 (DEV)
================================================================================
Projekt         : R+MUNI Blueprint
Dokument        : HLP09_How2_S105
Tag             : #dev #how2 #hlp #hlp09 #reportserver #s105
Datum           : 2026-04-14
Stage           : S105 — AKTIV
Status          : AKTIV
...
Jira-Sync       : NEIN
Erstellt        : 2026-03-07
Letzte Änderung : 2026-04-14 — S105-Update | Pfade geprüft und korrigiert
Ablageort       : 02-how2/HLP09_How2_S105.md
================================================================================
...
- root.cfg vorhanden und korrekt konfiguriert
- webconfig.txt in 01-artifacts/05-reports/ vorhanden und konfiguriert
...
In Archi:
  ...
  Zielordner waehlen:
    <BLUEPRINT_ROOT>/01-artifacts/05-reports/00-archimate/<Modellname>/
...
Datei: 01-artifacts/05-reports/webconfig.txt
...
Regeln:
  - PATH ist relativ zu 01-artifacts/05-reports/
...
================================================================================
  ...
  root.cfg wird automatisch zwei Ebenen aufwaerts gesucht.
  Log: 02-stages/99-logs/HLP09-serve_report.log (append)
...
================================================================================
  ...
  1. In Archi HTML Report exportieren nach:
       01-artifacts/05-reports/<weltordner>/<Modellname>/
...
================================================================================
  ...
  → Datei in 01-artifacts/05-reports/ anlegen
  ...
  → Ordner in 01-artifacts/05-reports/ manuell anlegen
...
================================================================================
  ...
  Script   : 01-artifacts/01-scripts/HLP09-serve_report.py
  ...
  Report-Ordner Struktur (Beispiel):
    01-artifacts/05-reports/
      ...
      99-html/
        Blueprint Struktur/    ← HTML Report (enthaelt index.html)
...
[[HLP_How2_S105]]             Kurzreferenz HLP-Reihe
[[HLP_principles_S105]]       Designprinzipien HLP-Reihe


================================================================================
HLP09 REPORT SERVER HOW2 | S105 | 2026-04-14 | R+MUNI Blueprint
================================================================================
