...
Dokument        : XML_FLOW_How2_S105
Tag             : #dev #how2 #xmlflow #s105
Datum           : 2026-04-14
Stage           : S105 — AKTIV
Status          : AKTIV
...
Ablageort       : R+MUNI Doku-public\02-how2\XML_FLOW_How2_S105.md
================================================================================
...
--------------------------------------------------------------------------------
- Python 3.10+
- BLUEPRINT_ROOT korrekt in root.cfg eingetragen (liegt im Blueprint-Root)
...
Schritt 1: Root auflösen
  ...
  → Liest root.cfg, löst BLUEPRINT_ROOT auf
  → Erzeugt: 02-stages/99-logs/XML00-root.resolved.txt
  → Erzeugt: 02-stages/99-logs/XML00-root.log
...
Schritt 2: Quellen einsammeln
  ...
  → Erzeugt je Quellentyp:
      02-stages/00-archimatearchive/XML01-sources.resolved.txt
      02-stages/01-bpmnarchive/XML01-sources.resolved.txt
...
Schritt 5: Merger ausführen
  ...
  → Erzeugt: 01-artifacts/00-xml/00-master/master.generated.xml

Schritt 6: Konsolidieren
  python XML05-clear_merge.py
  → Liest sync.txt
  → Löst id/identifier Duplikate auf (merge-Action)
  → Verwendet xml.etree.ElementTree (stdlib, kein lxml)
  → Erzeugt: 01-artifacts/00-xml/00-master/master.cleared.xml
...
01-artifacts/00-xml/child_mapping.txt
...
01-artifacts/00-xml/01-mapping/mapping.txt
...
01-artifacts/00-xml/02-sync/sync.txt
