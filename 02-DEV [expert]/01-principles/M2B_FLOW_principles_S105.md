...
Dokument        : M2B_FLOW_principles_S105
Tag             : #dev #principles #m2bflow #s105
Datum           : 2026-04-14
Stage           : S105 — AKTIV
Status          : AKTIV
...
Jira-Sync       : NEIN
Erstellt        : 2026-03-02
Letzte Änderung : 2026-04-14 — S105-Update | Basis: M2B_FLOW_principles_S8.md
Ablageort       : 01-principles/M2B_FLOW_principles_S105.md
================================================================================
...
9. BPMN-ID WRITEBACK (M2B06)
--------------------------------------------------------------------------------
M2B06 liest alle active BPMN Dateien und schreibt die BPMN Process ID
als Property "BPMN_ID" zurück in das zugehörige Archi-Element in master.xml.

Regeln:
  - BPMN_ID wird NUR gesetzt wenn sie noch nicht vorhanden ist (immutable)
  - BPMN_ID wird NIE überschrieben wenn bereits gesetzt
...
Match-Hierarchie:
  ...
  3. Kein Match → überspringen, nur loggen

master.xml.bak wird vor dem Schreiben erstellt (Safety-Backup).

M2B06 ist ein einmaliger Schritt nach M2B05 der die Rückkopplung
zwischen BPMN und Archi über die Property-Ebene sicherstellt.


10. SCOPE-SNAPSHOT (M2B07)
--------------------------------------------------------------------------------
M2B07 scannt master.xml nach allen (sourceSystem, sourceModel) Kombinationen
...
werden ersetzt. M2B07 ist idempotent.


11. GRENZEN DES M2B FLOWS
--------------------------------------------------------------------------------
...
- M2B06 BPMN_ID ist immutable: einmal gesetzt, nie überschrieben


================================================================================
M2B_FLOW_principles_S105 | 2026-04-14 | R+MUNI Blueprint | Stage 1.05
================================================================================
