...
Dokument        : ATL_FLOW_principles_S105
Tag             : #dev #principles #atlflow #atlassian #s105
Datum           : 2026-04-14
Stage           : S105 — AKTIV
Status          : AKTIV
...
Ablageort       : 99-doku/01-principles/ATL_FLOW_principles_S105.md
================================================================================
...
--------------------------------------------------------------------------------
02-stages/run-scope.txt steuert welche Modelle ATL01 verarbeitet.
...
Kein Report-Ordner. 01-artifacts/05-reports/ wird von ATL nicht verwendet.
Ordner 01-artifacts/05-reports/00-archimate/99-ATL/ wird nicht angelegt.
...
14. LOG-VERHALTEN
--------------------------------------------------------------------------------
Jede Stage schreibt ein eigenes Log nach 02-stages/99-logs/:
