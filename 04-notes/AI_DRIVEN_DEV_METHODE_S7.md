...
================================================================================
Erstellt        : 2026-03-06
Letzte Änderung : 2026-03-22 — S7-final: Konsolidierung, Kap. 17 neu,
                               Schlankheits-Revision, BETA-Kanal
Autor           : EUMAXL
...
Visuelle Assets (MUNI-Figuren, Flipcharts) werden lokal mit
Stable Diffusion + LoRA umgesetzt — einmal trainiert, reproduzierbarer Stil.
Scope: DEV-only. Kein Ersatz für draw.io oder Archi-Diagramme.

!! OFFENER BACKLOG-PUNKT — Freigabe durch EUMAXL erforderlich !!
  Hardware (VRAM) mit Copilot klären → Sprint anlegen → Sprint-Doku → Freigabe.
