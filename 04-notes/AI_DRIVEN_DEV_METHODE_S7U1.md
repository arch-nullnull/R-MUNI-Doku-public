...
================================================================================
Erstellt        : 2026-03-06
Letzte Änderung : 2026-03-22 — Kap. 17 neu (S7U1): KI-Tool-Rollentrennung
...
Kanal: [MLAT] = Erfahrungsbericht, kein Transfer
       [MLAT→RMUNI] = explizit gewünschter Transfer in R+MUNI
...
Claude meldet aktiv wenn er Verhaltensveränderungen wahrnimmt.
...
================================================================================
13. WISSENSTRANSFER ZWISCHEN ROLLEN — MLAT-KANAL
================================================================================
...
Template-first: Gibt es ein Template → Template laden, kein altes .md.
                S6-Templates: Stage_Ziele, Rosetta-Stone, how2_DEV, how2_USER,
                GOV_Global, Sprint-DEV-BACKLOG, Sprint-DEV-Doku, TMP_How2_DEV


================================================================================
16. PROJEKTMANAGEMENT MIT CLAUDE — CHAT-STRUKTUR UND DRIFT-PRÄVENTION
================================================================================
Erweiterung Stage 7 | 2026-03-22
...
16.3 Verhaltenstransparenz als Methodik-Werkzeug
-------------------------------------------------
Claude meldet auf expliziten Wunsch aktiv wenn er Strukturen einsetzt die
nicht verlangt wurden oder sein Verhalten durch Nutzungsmuster ändert.

Aktivierung: "Ich möchte dass du mir aktiv sagst wenn du dein Verhalten
              aufgrund meines Verhaltens veränderst."

Gilt gezielt für Methodik-Chats — nicht als Dauermodus.
...
================================================================================
17. KI-TOOL-ROLLENTRENNUNG UND VISUAL ASSET PIPELINE
================================================================================
Erweiterung Stage 7 Update 1 | 2026-03-22

17.1 KI-Tool-Rollentrennung
-----------------------------
Nicht jedes KI-Tool passt für jeden Usecase. Im R+MUNI DEV-Kontext gilt
eine klare Rollentrennung zwischen den eingesetzten KI-Werkzeugen.

  Claude     Gesamtprojektbegleitung, Code, Dokumentation, Strukturarbeit
             Kontext: vollständiger Blueprint-Kontext, GOV-konform
             Primäres Werkzeug für alle technischen und konzeptionellen Arbeiten

  Copilot    Exploration und Entscheidungsfindung ohne Blueprint-Hintergrund
             Dokumentationsglättung mit Außenwirkung (Sales, nicht technisch)
             Kontext: bewusst kontextfrei — keine R+MUNI-Dokumente
             Auswertung fließt als [MLAT→RMUNI] Transfer zurück wenn relevant

Prinzip: Claude kennt das System. Copilot kennt es bewusst nicht.
         Erkenntnisse aus Copilot-Sessions werden kontrolliert transferiert.

17.2 Visual Asset Pipeline — Stable Diffusion + LoRA
------------------------------------------------------
Für alle visuellen Assets (MUNI-Figuren, Flipcharts, Präsentationsbilder)
wird eine lokale Stable-Diffusion-Pipeline mit LoRA-Training eingesetzt.

Entscheidungsbegründung:
  Cloud-basierte Bildgeneratoren (Copilot, Midjourney) liefern keinen
  fixierbaren Stil — jede Ausgabe ist eine neue Stilentscheidung.
  Stable Diffusion + LoRA löst das strukturell:
  - Einmaliges Training auf vorhandenen MUNI-Assets → fixer, reproduzierbarer Stil
  - Lokal ausführbar → keine Cloud-Kosten, keine Datenschutzfragen
  - Deterministisch und wiederholbar — Blueprint-Prinzip gilt auch für Visuals

Scope: DEV-only — nicht User-relevant, kein R+MUNI-Kern-Stack
       Trainingsdaten: vorhandene MUNI-Grafiken und Flipchart-Assets

Aktueller Stand: Backlog-Eintrag angelegt
                 [[Sprint-DEV-BACKLOG_VisualAsset-SD-LoRA_S7]]
                 Hardware-Voraussetzungen (VRAM) noch zu prüfen

Workflow (nach Sprint-Umsetzung):
  MUNI-Assets kuratieren → LoRA trainieren → Stable Diffusion lokal ausführen
  → PNG-Output → Inkscape (SVG wenn nötig) → Ablage Doku-creative

17.3 Abgrenzung — was diese Pipeline nicht ist
------------------------------------------------
  - Kein Ersatz für draw.io oder Archi-Diagramme (andere Zwecke)
  - Kein User-Tool — nur DEV-intern
  - Kein automatisierter Bestandteil der R+MUNI Script-Pipeline
  - Midjourney bleibt evaluierbar für spätere Stages wenn "Wow"-Faktor gefragt
...
Erweiterung Kapitel 17 (S7U1) | 2026-03-22
================================================================================
