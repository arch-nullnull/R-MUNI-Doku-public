================================================================================
<TITEL> — BACKLOG (Associate)
================================================================================
Projekt         : <Projektname>
Dokument        : ASSOCIATE_Backlog
Tag             : #associate #backlog #<thema>
Datum           : <YYYY-MM-DD>
Stage           : S7 — AKTIV
...
<Kurze Beschreibung des Auslösers>

Was ist der gewünschte Zielzustand?
<Was soll am Ende erreicht sein — aus Anwenderperspektive>

Warum jetzt noch nicht?
<Begründung warum zurückgestellt — Priorität, Abhängigkeit, Aufwand>
